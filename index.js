...
function getArtistByIndex(/*Your Code Here*/artists, index) {
  /*Your Code Here*/
...
function removeArtist(/*Your Code Here*/artists, index) {
  /*Your Code Here*/
  return artists.filter(artist => artist !== artists[index])
}
...
function addArtist(/*Your Code Here*/artists, name, years, genre, nationality, bio) {
  /*Your Code Here*/
...
function artistInfo(/*Your Code Here*/artists, name){
  /*Your Code Here*/
  let bio = artists.filter(artist => artist['name'] === name)
  return bio[0]['bio']
}
